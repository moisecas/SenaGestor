...
public interface MovimientosRepository extends JpaRepository<Movimiento, Integer>{
    ...
    public abstract ArrayList<Movimiento> findByEmpleado(Integer id);
    ...
    public abstract ArrayList<Movimiento> findByEmpresa(Integer id);
    ...
    @Query(value="select id from empleados where correo=?1", nativeQuery = true)
